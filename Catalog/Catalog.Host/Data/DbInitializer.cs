...
public static class DbInitializer
{
    ...
    private static IEnumerable<CatalogItem> GetPreconfiguredItems()
    {
        ...
        {
            new CatalogItem { CatalogCategoryId = 1, CatalogMechanicId = 2, Description = "In 10 Minute Heist: The Wizard's Tower, you and your fellow thieves steal as much loot as possible! ", Name = "10 Minute Heist: The Wizard's Tower", Price = 9.55M, PictureFileName = "1.png" },
            new CatalogItem { CatalogCategoryId = 1, CatalogMechanicId = 1, Description = "13 Days is a game recreating the tension of those two weeks as players play cards which shape political events around the world.", Name = "13 Days: The Cuban Missile Crisis", Price = 20.50M, PictureFileName = "2.png" },
            new CatalogItem { CatalogCategoryId = 1, CatalogMechanicId = 1, Description = "2 de Mayo is based on the terrible events that took place in Madrid on May 2nd 1808.", Name = "2 de Mayo", Price = 50.35M, PictureFileName = "3.png" },
            ...
            new CatalogItem { CatalogCategoryId = 2, CatalogMechanicId = 3, Description = "Players can select from 16 unique playable investigator characters, each with unique abilities, and will square off against the diabolical servants of 8 Ancient Ones", Name = "Arkham Horror", Price = 29.39M, PictureFileName = "6.png" },
            ...
            new CatalogItem { CatalogCategoryId = 4, CatalogMechanicId = 4, Description = "The challenge is to intelligently allocate your eight rolled dice among the five buildings to acquire the fame you need to win the game", Name = "Alea Iacta Est", Price = 35, PictureFileName = "8.png" },
            new CatalogItem { CatalogCategoryId = 4, CatalogMechanicId = 2, Description = "Combine spell cards into three-piece combos, creating hundreds of unique and devastating attacks. The chaos is limited only by your thirst for destruction!", Name = "Epic Spell Wars of the Battle Wizards", Price = 226, PictureFileName = "9.png" },
            new CatalogItem { CatalogCategoryId = 4, CatalogMechanicId = 3, Description = "Codenames is a social word game with a simple premise and challenging game play", Name = "Codenames", Price = 9.79M, PictureFileName = "10.png" },
