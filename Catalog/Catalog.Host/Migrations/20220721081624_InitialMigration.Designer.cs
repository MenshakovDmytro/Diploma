...
namespace Catalog.Host.Migrations
{
    ...
    [Migration("20220721081624_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence("catalog_mechanic_hilo")
                .IncrementsBy(10);
            ...
            modelBuilder.Entity("Catalog.Host.Data.Entities.CatalogItem", b =>
                {
                    ...
                    b.Property<int>("CatalogMechanicId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("CatalogMechanicId");

                    b.ToTable("Catalog", (string)null);
                });

            modelBuilder.Entity("Catalog.Host.Data.Entities.CatalogMechanic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseHiLo(b.Property<int>("Id"), "catalog_mechanic_hilo");
                    ...
                    b.ToTable("CatalogMechanic", (string)null);
                });
            ...
            modelBuilder.Entity("Catalog.Host.Data.Entities.CatalogItem", b =>
                {
                    ...
                    b.HasOne("Catalog.Host.Data.Entities.CatalogMechanic", "CatalogMechanic")
                        .WithMany()
                        .HasForeignKey("CatalogMechanicId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CatalogCategory");

                    b.Navigation("CatalogMechanic");
                });
